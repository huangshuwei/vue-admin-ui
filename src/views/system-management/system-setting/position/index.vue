			...
			<i-main-container 
				...
				<el-row class="operation-btns">
					...
					<el-button 
						...
						size="medium"
						plain 
						@click.native.stop="deletePosition">删除
					</el-button>
...
<script>
    ...
    import DmDialog from './position-dialog'
    ...
    export default {
        ...
        methods: {
            ...
            restTableSelectedInfo() {
                ...
                this.$refs.positionTable.setCurrentRow(null);
            },
